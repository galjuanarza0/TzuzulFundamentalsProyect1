...
||--todo puede cambiar, o no...--------------
    ...
    let seguir = false
    while (!seguir) {
        console.log("||--Si quieres ayuda escribe 'help'")
        let comenzar = prompt("||--Escribe 'RITUALS' para empezar a jugar:")
        if (comenzar == "RITUALS") {
            seguir = true
            continue
        }
...
||--para seleccionar una debes escribir excactamente------
||--lo que dice la opcion---------------------------------
||--La historia cambiara por cada eleccion que tomes.-----
||--Asi que ten mucho cuidado con lo que eliges-----------
            `)
        }
    }
}
